...
function BrowserHomeScreen(): React.JSX.Element {
    ...
    const isCurrentNewTab = browserContext.currentWebTab.url === undefined;
    ...
    const AddressBar: React.JSX.Element = (
        <BrowserHomeAddressBar />
    );
    ...
    const NewTabView: React.JSX.Element = (
        <BrowserHomeNewTabView />
    );

    return (
        <BrowserHomeContextProvider
            uri={browserContext.currentWebTab.url || ''}
