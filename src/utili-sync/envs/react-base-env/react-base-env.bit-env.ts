/**
* this env extends react-env version 1.0.16.
* to inspect its config @see https://bit.cloud/teambit/react/react-env?version=1.0.16
* */
...
export class ReactBaseEnv extends ReactEnv {
...
export default new ReactBaseEnv();